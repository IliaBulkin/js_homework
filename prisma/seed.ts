...
async function createManyComment() {
    const comment = await prisma.comment.createMany({
        data: [
            {description: "first comment without image, createMany", contact: "abobus@aboba.com", postId: 2},
            {description: "second comment without image, createMany", contact: "abulbek@aboba.com", postId: 1},
            {description: "third comment without image, createMany", contact: "adukmook@aboba.com", postId: 2},
        ],
    })
}
